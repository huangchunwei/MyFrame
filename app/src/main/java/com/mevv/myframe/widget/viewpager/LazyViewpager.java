package com.mevv.myframe.widget.viewpager;
...
public class LazyViewpager extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE && (ii = infoForChild(child)) != null) {
                ...
                child.layout(childLeft, childTop, childLeft + child.getMeasuredWidth(), childTop + child
                        .getMeasuredHeight());
            }
        }
        mFirstLayout = false;
     ...
     */
       ...
       */
                ...
                final boolean atEdge = (dx > 0 && scrollX == 0) || (dx < 0 && mAdapter != null && scrollX >=
                        (mAdapter.getCount() - 1) * getWidth() - 1);
    ...
    public void draw(Canvas canvas) {
        ...
        if (overScrollMode == ViewCompat.OVER_SCROLL_ALWAYS || (overScrollMode == ViewCompat
                .OVER_SCROLL_IF_CONTENT_SCROLLS && mAdapter != null && mAdapter.getCount() > 1)) {
    ...
    public void endFakeDrag() {
        ...
        mPopulatePending = true;
        if ((Math.abs(initialVelocity) > mMinimumVelocity) || Math.abs(mInitialMotionX - mLastMotionX) >= (getWidth()
                / 3)) {
        ...
        if (v instanceof ViewGroup) {
            ...
            for (int i = count - 1; i >= 0; i--) {
                ...
                if (x + scrollX >= child.getLeft() && x + scrollX < child.getRight() && y + scrollY >= child.getTop()
                        && y + scrollY < child.getBottom() && canScroll(child, true, dx, x + scrollX - child.getLeft
