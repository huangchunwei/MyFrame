package com.mevv.myframe.widget.behavior;
...
//        Logger.d("dyConsumed="+dyConsumed+ " mIsAnimatingOut="+mIsAnimatingOut+" Visibility="+child.getVisibility()+" "+" Y="+child.getTranslationY());
