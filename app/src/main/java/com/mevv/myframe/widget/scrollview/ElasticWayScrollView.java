package com.mevv.myframe.widget.scrollview;
 ...
 */
public class ElasticWayScrollView extends ScrollView {
	...
	public ElasticWayScrollView(Context context) {
		super(context);
	}

	public ElasticWayScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
		...
		if (animationFinish) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				if (isNeedMove()) {
					...
					innerView.layout(innerView.getLeft(), innerView.getTop()
							- deltaY / 2, innerView.getRight(),
