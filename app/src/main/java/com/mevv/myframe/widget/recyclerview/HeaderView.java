...
public class HeaderView extends LinearLayout implements BaseHeader{

    private LinearLayout mContainer;
    private ImageView mArrowImageView;
    private ViewSwitcher mProgressBar;
    ...
    private void initView() {
        ...
        mProgressBar = (ViewSwitcher) findViewById(R.id.listview_header_progressbar);
